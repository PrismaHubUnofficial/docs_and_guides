...
To power the batteries on or off:

1. Press the buttons on **both batteries simultaneously**, using the following sequence:
   - **one short press**
   - **one long press**
...
- Press the **two holes** on each battery **toward the center**
...
1. Turn on **both side batteries simultaneously**
   - **one short press**
   - **one long press**
2. Wait for the startup sequence to complete

After power-on, the robot remains **stiff** for approximately **1–2 minutes**.  
It then switches to **DAMPING MODE** and is ready to receive commands.
...
4. **DEBUG MODE**  
   Not relevant for normal operation.
...
- **Left analog stick** → walking in all directions
- **Right analog stick** → yaw control
- **X button** → lowers the center of mass
- **Y button** → raises the center of mass

---

## Shutdown Procedure

To shut down the robot safely:
